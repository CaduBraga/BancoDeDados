...
id_coordenador int (11) not null auto_increment primary key,
CPF_coordenador varchar (11),
telefoneProfessor varchar (15),
nome_coordenador varchar (85),
curso_coordenador varchar (40)
);
create table funcionarios(
id_colaborador int (11) not null auto_increment primary key,
CPF_colaborador varchar (11),
telefone_colaborador varchar (15),
nome_colaborador varchar (85),
setor varchar (40),
salario int (8)
);
create table terceiros(
id_empresa int (11) not null auto_increment primary key,
CNPJ_terceiros varchar (14),
telefone_terceiros varchar (15),
nome_fantasia varchar (85),
servico_prestado varchar (40),
data_pagamento date
);
