...
alter table curso add column cargaHoraria int (8);
...
alter table alunos modify column sexoAluno varchar (12);
...
alter table alunos drop sexoAluno;
alter table alunos drop descricao_curso;
...
#PS.: DIA 24/10 (dois dias depois da atividade) percebi que tinham alguns erros de sintaxe que foram arrumados na Aula 3.
